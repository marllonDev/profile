...
const translations = {
  pt: {
    ...
    'sobre-text-1': 'Engenheiro de Dados com foco em <strong>pipelines, Big Data e IA aplicada</strong>, apaixonado por projetos open source. Trabalho com ecossistemas de dados end-to-end — da ingestão ao consumo — usando Spark, Kafka, Airflow e Databricks no dia a dia.',
  ...
  en: {
    ...
    'sobre-text-1': 'Data Engineer focused on <strong>pipelines, Big Data and applied AI</strong>, passionate about open source projects. I work with end-to-end data ecosystems — from ingestion to consumption — using Spark, Kafka, Airflow and Databricks every day.',
