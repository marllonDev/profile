...
const translations = {
  pt: {
    ...
    'sobre-text-1': '<strong>Senior Data Engineer</strong> com <strong>5+ anos</strong> de experiência na interseção entre engenharia de dados e inovação. Já atuei em setores que movem economias — grandes bancos brasileiros, seguradoras globais e a maior produtora de cerveja do mundo — e hoje direciono impacto no setor de crédito na <strong>Consórcio Embracon</strong>. Formado em Análise e Desenvolvimento de Sistemas com <strong>MBA em Engenharia de Dados</strong>, apaixonado por open source e democratização de dados.',
    ...
    'sobre-text-3': 'Arquiteto pipelines robustos para players Fortune 500, migro sistemas legados para arquiteturas cloud-native (AWS/Azure) e entrego frameworks ETL/ELT escaláveis. Hoje uso <strong>Claude Code</strong> como copiloto principal, roteando modelos via <strong>OpenRouter</strong> — cada contexto, sua melhor ferramenta.',
  ...
  en: {
    ...
    'sobre-text-1': '<strong>Senior Data Engineer</strong> with <strong>5+ years</strong> of expertise at the intersection of data engineering and innovation. I\'ve driven impact across sectors that shape economies — Brazil\'s largest banks, global insurance leaders, and the world\'s top beer producer — now crafting scalable data ecosystems in the credit sector at <strong>Consórcio Embracon</strong>. BSc in Systems Analysis & Development and <strong>MBA in Data Engineering</strong>, passionate about open source and data democratization.',
    ...
    'sobre-text-3': 'I\'ve architected robust data pipelines for Fortune 500 players, migrated legacy systems into cloud-native powerhouses (AWS/Azure), and delivered scalable ETL/ELT frameworks. Today I use <strong>Claude Code</strong> as my main copilot, routing models via <strong>OpenRouter</strong> — each context, its best tool.',
